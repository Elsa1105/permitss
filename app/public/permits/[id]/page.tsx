    ...
    <main className="min-h-screen bg-slate-100 px-4 py-8">
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="text-center">
          ...
          <a
            href={`/api/public/permits/${p.id}/pdf`}
            className="mt-4 inline-flex items-center justify-center rounded-lg bg-slate-950 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-800"
          >
            Open PDF
          </a>
        </div>
